...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('data\\species.json', 'data'), ('data\\taming.json', 'data'), ('data\\tributes.json', 'data')],
    hiddenimports=['sounds', 'hudread', 'calc_page', 'theme', 'tribute', 'tribute_page', 'tribute_read'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
